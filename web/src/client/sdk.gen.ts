 ...
 */
export const getMediaFileById = <ThrowOnError extends boolean = false>(options: Options<GetMediaFileByIdData, ThrowOnError>): RequestResult<GetMediaFileByIdResponses, GetMediaFileByIdErrors, ThrowOnError> => (options.client ?? client).get<GetMediaFileByIdResponses, GetMediaFileByIdErrors, ThrowOnError>({ url: '/media/files/{media_id}', ...options });
