...
colors:
  ...
  state-queued-bar: '#00000000'   # transparent fill; 1px dashed border in {colors.muted-foreground} at 60% (3.37:1 on background)
...
**Non-text (65 pairs):** all ≥ 3.0; the lowest are the control border on the page (3.02), the queued outline and beyond-palette band at 60% (3.29–3.37), the density floor at 0.60 (3.30–3.61), and the lap-2 bands (3.52–4.28, also hatched); kind chip borders are 3.96–4.38 and sit inside a chip whose text is AAA.
...
| Assign thread hues by first-mention ordinal and always print the name with its lap swatch | Assign hues by list position, or identify a thread by color alone |
