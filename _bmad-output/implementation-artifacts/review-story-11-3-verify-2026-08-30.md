...
- Resolution: Open — strengthen the test red-first so it pins the governing README and RUNBOOK exception paragraphs independently, then restore the mutated documentation and confirm green.
