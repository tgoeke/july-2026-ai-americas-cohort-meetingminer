...
- [x] [Review][Patch][F3] Enforce `timeout_seconds` as one finite request deadline [`server/meetingminer/adapters/diarize/remote_http.py:165`]
- [x] [Review][Patch][F4] Size multipart uploads from the opened file descriptor [`server/meetingminer/adapters/diarize/remote_http.py:156`]
