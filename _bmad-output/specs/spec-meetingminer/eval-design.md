...
- Graph traversal: the participants → meetings → topics → moments query (Rowan demo) has a fully known expected result set from the scripts; exact-set comparison.
