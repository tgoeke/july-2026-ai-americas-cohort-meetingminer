...
generated `.env.worktree`. About 2 GiB idle per stack; AGENTS.md carries the measurement and the Docker
VM bound. The api and web ports are still the same in every checkout.
